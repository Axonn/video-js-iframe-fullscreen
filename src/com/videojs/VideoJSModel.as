package com.videojs{
    ...
    public class VideoJSModel extends EventDispatcher{
		public var have_liverail:Boolean = false; //Vidcaster Tanel Edit
        ...
        public function set src(pValue:String):void{
            ...
            if(_autoplay){
               ...
               // _provider.play(); //Vidcaster Tanel Edit
            }
            else if(_preload){
                _provider.load();
            }
        ...
        private function initProvider():void{
            ...
            var __src:Object;
			//Vidcaster Tanel Edit
			var current_autoplay:* = _autoplay;
			if(have_liverail)current_autoplay = false;
			//Vidcaster Tanel Edit END
            ...
            switch(_mode){
                case PlayerMode.VIDEO:
                    ...
                    if(_currentPlaybackType == PlaybackType.HTTP){
                        ...
                        _provider.init(__src, current_autoplay); //Vidcaster Tanel Edit
                    }
